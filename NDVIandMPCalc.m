...
load('CSCBAmb.mat','CSCBAmb');
load('CSCBDry.mat','CSCBDry');
load('CSCBWet.mat','CSCBWet');
load('CSCBNDVI.mat','CSCBNDVI');
...
load('CSWFAmb.mat','CSWFAmb');
load('CSWFDry.mat','CSWFDry');
load('CSWFWet.mat','CSWFWet');
load('CSWFNDVI.mat','CSWFNDVI');
...
load('GLCBAmb.mat','GLCBAmb');
load('GLCBDry.mat','GLCBDry');
load('GLCBWet.mat','GLCBWet');
load('GLCBNDVI.mat','GLCBNDVI');
...
load('GLWFAmb.mat','GLWFAmb');
load('GLWFDry.mat','GLWFDry');
load('GLWFWet.mat','GLWFWet');
load('GLWFNDVI.mat','GLWFNDVI');
...
load('CSCBHousekeeping.mat','CSCBHousekeeping');
load('CSWFHousekeeping.mat','CSWFHousekeeping');
load('GLCBHousekeeping.mat','GLCBHousekeeping');
load('GLWFHousekeeping.mat','GLWFHousekeeping');